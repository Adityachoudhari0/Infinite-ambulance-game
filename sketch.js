//made by aditya
//declaring the all variables
var ambulance,ambulanceimg, ambulance_animation;
...
//loading all the images of ambulance,cars and trucks
  ambulanceimg = loadImage
  ("ambulance_1.png", "ambulance_2.png", "ambulance_3.png");
...
//add the sounds
  backSound=loadSound("ambulance-sound-27708.mp3")
...
//instruction for Sound always play
  backSound.loop();
//creating the road
...
//creating the ambulance
  ambulance = createSprite( 50, 440, 40, 40);
  ambulance.addAnimation("runing", ambulance_animation)
  ambulance.scale = 0.5;
  
//creating the boundary
  left_boundary = createSprite(22, 250, 2, 500);
  right_boundary = createSprite(380, 250, 5, 500);
}
